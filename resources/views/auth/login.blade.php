<x-guest-layout>
        ...
        <div class="flex-auto p-6">
            <form method="POST" action="{{ route('login') }}">
                @csrf
                <label class="mb-2 ml-1 font-bold text-xs text-slate-700">Email/Username</label>
                <div class="mb-4">
                    <input type="text" name="identity" :value="old('email')" required autofocus autocomplete="username"
                        class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow"
                        placeholder="Email/Username" aria-label="Email" aria-describedby="email-addon" />
                </div>
        ...
        <div
            ...
            <p class="mx-auto mb-6 leading-normal text-sm">
                ...
                <a href="../softui/pages/sign-up.html"
